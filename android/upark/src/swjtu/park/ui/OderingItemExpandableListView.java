...
public class OderingItemExpandableListView extends ExpandableListView implements
		OnScrollListener, OnGroupClickListener {

	public OderingItemExpandableListView(Context context, AttributeSet attrs,
			int defStyle) {
	...
	public OderingItemExpandableListView(Context context) {
		super(context);
		registerListener();
	}
