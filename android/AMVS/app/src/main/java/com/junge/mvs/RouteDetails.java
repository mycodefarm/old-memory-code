...
public class RouteDetails {
    ...
    private boolean throughPointMarkerVisible = false;
    ...
    private  List<DriveStep> drivePaths;
     ...
     */
    public RouteDetails(AMap amap, DrivePath path,
    ...
    private void colorWayUpdate() {
        ...
        for (int i = 0; i < mLatLngsOfPath.size() ; i++) {
